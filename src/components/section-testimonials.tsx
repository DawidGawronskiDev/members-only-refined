        ...
        <div className="flex flex-col items-center justify-center gap-16">
          ...
          <div className="flex flex-4 gap-4">
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-2 border border-gray-100/10 p-4 rounded-2xl bg-gray-100/5 shadow-sm">
                ...
                <div className="flex gap-3">
                  ...
                  <p className="text-white opacity-100 font-bold">Alex M.</p>
                </div>
              </div>
              <div className="flex flex-col gap-2 border border-gray-100/10 p-4 rounded-2xl bg-gray-100/5 shadow-sm">
                <blockquote className="font-extralight">
                ...
                <div className="flex gap-3">
                  <div className="w-8 aspect-square rounded-full from-orange-600 to-black bg-gradient-to-br"></div>
                  <p className="text-white opacity-100 font-bold">Sarah L.</p>
                </div>
              </div>
              <div className="flex flex-col gap-2 border border-gray-100/10 p-4 rounded-2xl bg-gray-100/5 shadow-sm">
                <blockquote className="font-extralight">
                ...
                <div className="flex gap-3">
                  <div className="w-8 aspect-square rounded-full from-orange-600 to-black bg-gradient-to-br"></div>
                  <p className="text-white opacity-100 font-bold">James R.</p>
                </div>
              </div>
            </div>
            <div className="hidden md:flex md:flex-col md:gap-4">
              <div className="flex flex-col gap-2 border border-gray-100/10 p-4 rounded-2xl bg-gray-100/5 shadow-sm">
                ...
                <div className="flex gap-3">
                  <div className="w-8 aspect-square rounded-full from-orange-600 to-black bg-gradient-to-br"></div>
                  <p className="text-white opacity-100 font-bold">Emily K.</p>
                </div>
              </div>
              <div className="flex flex-col gap-2 border border-gray-100/10 p-4 rounded-2xl bg-gray-100/5 shadow-sm">
                <blockquote className="font-extralight">
                ...
                <div className="flex gap-3">
                  <div className="w-8 aspect-square rounded-full from-orange-600 to-black bg-gradient-to-br"></div>
                  <p className="text-white opacity-100 font-bold">Rachel W.</p>
                </div>
              </div>
              <div className="flex flex-col gap-2 border border-gray-100/10 p-4 rounded-2xl bg-gray-100/5 shadow-sm">
                <blockquote className="font-extralight">
                ...
                <div className="flex gap-3">
                  <div className="w-8 aspect-square rounded-full from-orange-600 to-black bg-gradient-to-br"></div>
                  <p className="text-white opacity-100 font-bold">Lisa N.</p>
                </div>
              </div>
            </div>
            <div className="hidden md:flex md:flex-col md:gap-4">
              <div className="flex flex-col gap-2 border border-gray-100/10 p-4 rounded-2xl bg-gray-100/5 shadow-sm">
                ...
                <div className="flex gap-3">
                  <div className="w-8 aspect-square rounded-full from-orange-600 to-black bg-gradient-to-br"></div>
                  <p className="text-white opacity-100 font-bold">David P.</p>
                </div>
              </div>
              <div className="flex flex-col gap-2 border border-gray-100/10 p-4 rounded-2xl bg-gray-100/5 shadow-sm">
                <blockquote className="font-extralight">
                ...
                <div className="flex gap-3">
                  <div className="w-8 aspect-square rounded-full from-orange-600 to-black bg-gradient-to-br"></div>
                  <p className="text-white opacity-100 font-bold">Tomek P.</p>
                </div>
              </div>
              <div className="flex flex-col gap-2 border border-gray-100/10 p-4 rounded-2xl bg-gray-100/5 shadow-sm">
                <blockquote className="font-extralight">
                ...
                <div className="flex gap-3">
                  <div className="w-8 aspect-square rounded-full from-orange-600 to-black bg-gradient-to-br"></div>
                  <p className="text-white opacity-100 font-bold">Mark T.</p>
                </div>
              </div>
            </div>
          </div>
